<script>
  ...
  function setActiveStateToLogin() {
    activeScreen = "login"
  }
...
<div class="flex flex-col xl:w-3/12 lg:w-5/12 md:w-6/12 w-full bg-slate-200 px-8 py-8 rounded-lg">
  <h1 class="text-4xl text-center mb-3">Register</h1>
  ...
  <button on:click={registerHandler} class="mt-3 border-none py-3 bg-slate-300 font-bold rounded-md hover:bg-slate-400">Register</button>
  <button on:click={setActiveStateToLogin} class="mt-3 border-none underline"  >Login</button>
</div>